...
class App extends Component {
  ...
  render() {
    ...
    if (this.state.loading) {
      content = (
        <p  id="loader" className="text-center text-white">
          Loading...Make sure to be on <u>kovan testnet</u>. Dapp will be deployed on Avalanche Mainet soon. App may run slower than usual... 
        </p>
      )
    } else {
      content = (
